...
{
public function create($event,$videogallery,$status,$order)
{
$data=array("event" => $event,"videogallery" => $videogallery,"status" => $status,"order" => $order);
...
public function edit($id,$event,$videogallery,$status,$order)
{
$data=array("event" => $event,"videogallery" => $videogallery,"status" => $status,"order" => $order);
$this->db->where( "id", $id );
