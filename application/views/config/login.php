<section class="panel">
	...
	<div class="panel-body">
		...
		<div class="logintype googleLogin">
			<div class="checkbox">
				<label class="form-checkbox form-normal form-primary active form-text">
					<input type="checkbox" name="Google">Google Login</label>
			</div>
		...
		<div class="logintype facebookLogin">
			<div class="checkbox">
				<label class="form-checkbox form-normal form-primary active form-text">
					<input type="checkbox" name="Facebook">Facebook Login</label>
			</div>
			<div class="sublogintype" style=" min-height: 110px;">
				<div class="form-group">
		...
		<div class="logintype twitterLogin">
			<div class="checkbox">
				<label class="form-checkbox form-normal form-primary active form-text">
					<input type="checkbox" name="twitter">Twitter Login</label>
			</div>
			<div class="sublogintype" style=" min-height: 110px;">
				<div class="form-group">
		...
		<div class="logintype instagramLogin">
			<div class="checkbox">
				<label class="form-checkbox form-normal form-primary active form-text">
					<input type="checkbox" name="instagram">Instagram Login</label>
			</div>
			<div class="sublogintype" style=" min-height: 110px;">
				<div class="form-group">
		...
		<div class="hidden123">
			...
			<form class='form-horizontal tasi-form loginform' method='post' action='<?php echo site_url("site/editconfigsubmit");?>' enctype='multipart/form-data' hidden="true">
