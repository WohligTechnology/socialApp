...
<div id="page-content">
    ...
    -->
                        ...
                        <div class=" form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="normal-field" class="form-control" name="logintype" value="<?php echo set_value('logintype');?>">
                            </div>
                        </div>
    ...
    -->
                        ...
                        <div class=" form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="address" id="" cols="20" rows="10" class="form-control tinymce"><?php echo set_value( 'address');?>
                                </textarea>
                            </div>
                        </div>
                        <div class=" form-group">
