...
return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.status + "</td><td>" + resultrow.title + "</td><td><a class='btn btn-primary btn-xs' href='<?php echo site_url('site/editarticles?id=');?>"+resultrow.id+"'><i class='icon-pencil'></i></a><a class='btn btn-danger btn-xs' onclick=return confirm(\"Are you sure you want to delete?\") href='<?php echo site_url('site/deletearticles?id='); ?>"+resultrow.id+"'><i class='icon-trash '></i></a></td></tr>";
}
